...
class ApiProductosOrden
{
    ...
    public function getProductosOrden($listadoProductos, $tipoOrden, $filtroOrden = '')
    {
        ...
        $res = $producto->queryProductosOrden($listadoProductos, $tipoOrden, $filtroOrden); //Variable que invoca la query de productosNombre
        ...
        } else if($res == 'ERROR') { //En caso contrario, primero valido si $res es igual a ERROR
            echo json_encode(array("mensaje" => "No hay datos"));
        } else {
            //Si no lo es, entonces muestro el error especifico para corregir
